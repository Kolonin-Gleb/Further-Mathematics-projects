...
#1 Промежуток (-2; 4)    Точность = 0.01    Ответ = 3.0            Результат + 
#2 Промежуток (-2.4; -1) Точность = 0.01    Ответ = -2             Результат - 
#3 Промежуток(-2.4; -1)  Точность = 0.01    Ответ = некор. данные  Результат - 
#4 Промежуток(-2; 2)     Точность = 0.01    Ответ = 1              Результат -
#5 Промежуток(-2; 2)     Точность = 0.00001 Ответ = 0              Результат -
